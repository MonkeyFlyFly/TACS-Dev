function total_items_deducted(){
	calc_Total_items_deducted();
}
function calc_Total_items_deducted(){
var ele_Fiscal_Year=bptEle("S3F20","S3F21","S3F22","S3F25","S3F26","S3F39");
var sum_Fiscal_Year=sum_total(ele_Fiscal_Year);
var s3f28=bptEle("S3F28");
$(s3f1[0]).val(sum_Fiscal_Year);
}
