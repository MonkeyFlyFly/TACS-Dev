function cost_of_borrowing(){
	calc_Cost_of_borrowing();
}
function calc_Cost_of_borrowing(){
	//This value should not exceeds S3F12, otherwise, system will limit this value to S3F12
