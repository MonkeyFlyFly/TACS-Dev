function schedule_8_s8f11(){
	calc_Schedule_8_s8f11();
}
function calc_Schedule_8_s8f11(){
//S8F11=(S8F5*S8F8)/2
var s8f5=bptEle("S8F5");
var s8f8=bptEle("S8F8");

var s8f11=bptEle("S8F11");
$(s8f11[0]).val(($(s8f5[0]).val() * $(s8f8[0]).val())/2);
