function schedule_3_S3F37(){
	calc_Schedule_3_S3F37();
}
function calc_Schedule_3_S3F37(){
	//S3F31=S2F14-S2F19

var ele_Fiscal_Year=bptEle("S3F30","S3F31","S3F32","S3F33","S3F34","S3F35");
var sum_Fiscal_Year=sum_total(ele_Fiscal_Year);
var s3f29=bptEle("S3F29");
var s3f31=bptEle("S3F31");
$(s3f31[0]).val($(s3f29[0]).val()-sum_Fiscal_Year);
}
