function schedule_4_S4F22(){
	calc_Schedule_4_S4F22();
}
function calc_Schedule_4_S4F22(){ 
var sum_ele=bptEle("S4F18","S4F19","S4F20");
var sum=sum_total(sum_ele);
var s4f21=bptEle("S4F21");
var s4f22=bptEle("S4F22");
$(s4f22[0]).val(sum-$(s4f21[0].val()));
}
