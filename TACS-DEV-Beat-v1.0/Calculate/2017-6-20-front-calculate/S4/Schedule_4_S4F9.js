function schedule_4_S4F9(){
	calc_Schedule_4_S4F9();
}
function calc_Schedule_4_S4F9(){ 
var sum_ele=bptEle("S4F5","S4F6","S4F7");
var sum=sum_total(sum_ele);
var s4f8=bptEle("S4F8");
var s4f9=bptEle("S4F9");
$(s4f9[0]).val(sum-$(s4f8[0]).val());
}
