function schedule_8_s8f10(){
	calc_Schedule_8_s8f10();
}
function calc_Schedule_8_s8f10(){
//S8F10=(S8F4*S8F8)/2
var s8f4=bptEle("S8F4");
var s8f8=bptEle("S8F8");

var s8f10=bptEle("S8F10");
$(s8f10[0]).val(($(s8f4[0]).val() * $(s8f8[0]).val())/2);
