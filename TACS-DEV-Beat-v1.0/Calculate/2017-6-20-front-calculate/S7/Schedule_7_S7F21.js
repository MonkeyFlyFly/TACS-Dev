function schedule_7_S7F21(){
	calc_Schedule_7_S7F21();
}
function calc_Schedule_7_S7F21(){

var s7f12=bptEle("S7F12");
var s7f21=bptEle("S7F21");
if($(s7f21[0]).val() > $(s7f12[0]).val()){
	$(s7f21[0]).val($(s7f12[0]).val());
}
