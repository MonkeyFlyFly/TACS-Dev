function schedule_2_S2F14(){
	calc_Schedule_2_S2F14();
}
function calc_Schedule_2_S2F14(){
//Should be equal as S11F22, if not, S2F14 prevails
var s2f14=bptEle("S2F14");
var s11f22=bptEle("S11F22");
if($(s2f14[0]).val()==""){
	$(s2f14[0]).val($(s11f22[0]).val());
}
}
