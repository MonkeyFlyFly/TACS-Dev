function schedule_2_S2F23(){
	calc_Schedule_2_S2F23();
}
function calc_Schedule_2_S2F23(){
var sum_ele=bptEle("S2F12","S2F14","S2F15","S2F17");
var sub_ele=bptEle("S2F18","S2F19","S2F20","S2F21","S2F22");
var sum=sum_toal(sum_ele);
var sum_sub=sum_sub_total(sub_ele);
var result=(sum+sum_sub);
var s2f23=bptEle("S2F23");
$(s2f23[0]).val(s2f23);
}
...
var sum_sub_total=function calTotal(arr){
	var arr_length=arr.length;
	var sum_toal=0;
	var temp="";
	for(var i=0; i< arr_length; i++){
