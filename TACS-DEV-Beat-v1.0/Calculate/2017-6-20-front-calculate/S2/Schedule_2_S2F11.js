function schedule_2_S2F11(){
	calc_Schedule_2_S2F11();
}
function calc_Schedule_2_S2F11(){
var sub_ele=bptEle("S2F9","S2F10");
var sub=sub_toal(sum_ele);
var s2f11=bptEle("S2F11");
$(s2f11[0]).val(sub);
}
