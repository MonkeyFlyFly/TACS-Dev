function schedule_2_S2F15(){
	calc_Schedule_2_S2F15();
}
function calc_Schedule_2_S2F15(){
//Should be equal as S11F31, if not, S2F15 prevails

var s2f15=bptEle("S2F15");
var s11f31=bptEle("S11F31");
if($(s2f15[0]).val()==""){
	$(s2f15[0]).val($(s11f31[0]).val());
}
}
