function schedule_5_S5F36(){
	calc_Schedule_5_S5F36();
}
function calc_Schedule_5_S5F36(){
var sum_ele=bptEle("S5F30","S5F31","S5F32","S5F33","S5F34","S5F35");
var sum=sum_total(sub_ele);
var s5f29=bptEle("S5F29");
var s5f36=bptEle("S5F36");
$(s5f36[0]).val($(s5f29[0]).val()-sum);
}
