function schedule_5_S5F21(){
	calc_Schedule_5_S5F21();
}
function calc_Schedule_5_S5F21(){ 
var s5f12=bptEle("S5F12");
var s5f21=bptEle("S5F21");
if($(s5f21[0]).val()>$(s5f12[0]).val()){
	$(s5f21[0]).val($(s5f12[0]).val());
}
}
