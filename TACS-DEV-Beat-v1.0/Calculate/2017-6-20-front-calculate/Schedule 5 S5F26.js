function schedule_5_s5f19(){
	calc_Schedule_5_s5f19();
}
function calc_Schedule_5_s5f19(){ 
var s4f26=bptEle("S4F26");
var s5f26=bptEle("S5F26");
if($(s5f26).val() > $(s4f26).val()){
	$(s5f26[0]).val($(s4f26).val());
}
}
