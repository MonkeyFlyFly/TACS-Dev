function schedule_4_s4f18(){
	calc_Schedule_4_s4f18();
}
function calc_Schedule_4_s4f18(){ 
var ele_Fiscal_Year=bptEle("S4F15","S4F16");
var sum_Fiscal_Year=sum_total(ele_Fiscal_Year);
var s4f17=bptEle("S4F17");
var s4f18=bptEle("S4F18");
$(s4f18[0]).val(sum_Fiscal_Year-$(s4f17[0].val()));
}
