function schedule_1_S1F31_S1F32(){
	calc_Schedule_1_S1F31_S1F32();
}
function calc_Schedule_1_S1F31_S1F32(){
var ele_Fiscal_Year=bptEle("S1F7","S1F29");
var ele_Previous_Fiscal_Year=bptEle("S1F8","S1F30");
var sum_Fiscal_Year=sum_total(ele_Fiscal_Year);
var sum_Previous_Fiscal_Year=sum_total(ele_Previous_Fiscal_Year);
var s1f31=bptEle("S1F31");
var s1f32=bptEle("S1F32");
$(s1f31[0]).val(sum_Fiscal_Year);
$(s1f32[0]).val(sum_Previous_Fiscal_Year);
}
