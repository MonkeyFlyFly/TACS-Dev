function schedule_3_S3F21(){
	calc_Schedule_3_S3F21();
}
function calc_Schedule_3_S3F21(){
var s3f12=bptEle("S3F12");
var s3f21=bptEle("S3F21");
if($(s3f21[0]).val() > $(s3f12[0]).val()){
	$(s3f21[0]).val($(s3f12[0]).val());
	}
}
