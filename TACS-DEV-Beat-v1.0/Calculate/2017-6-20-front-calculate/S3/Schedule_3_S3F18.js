function schedule_3_S3F18(){
	calc_schedule_3_S3F18();
}
function calc_schedule_3_S3F18(){
var sum_ele=bptEle("S3F2","S3F3","S3F4","S3F40","S3F5","S3F6","S3F7","S3F8","S3F9","S3F10","S3F11","S3F12","S3F13","S3F14","S3F15","S3F16","S3F38");
var sum=sum_total(sum_ele);
var s3f18=bptEle("S3F18");
$(s3f18[0]).val(sum);
}
