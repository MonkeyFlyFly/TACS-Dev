function schedule_6_s6f15(){
	calc_Schedule_6_s6f15();
}
function calc_Schedule_6_s6f15(){
	
	//S6F15=S6F5+S6F6+S6F7+S6F9-S6F10-S6F11-S6F12-S6F13-S6F14

var sum_ele=bptEle("S6F5","S6F6","S6F7","S6F9");
var sum=sum_total(sum_ele);
var sub_ele=bptEle("S6F10","S6F11","S6F12","S6F13","S6F14");
var sub=sub_total(sub_ele);
var s6f15=bptEle("S6F15");
$(s6f15[0]).val(sum-sub);
}
