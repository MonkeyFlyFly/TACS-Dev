function gross_taxable_profit(){
	calc_gross_taxable_profit();
}
function calc_gross_taxable_profit(){
var ele_Fiscal_Year=bptEle("S3F1","S3F18");
var sum_Fiscal_Year=sum_total(ele_Fiscal_Year);
var s3f19=bptEle("S3F19");
$(s3f19[0]).val(sum_Fiscal_Year);
}
